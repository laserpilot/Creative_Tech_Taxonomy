# Creative Tech Mindmap
 ...
 Originally created as a visual map. I later adapted this idea to a JSON structure for easy modification and portability to other environments. 
